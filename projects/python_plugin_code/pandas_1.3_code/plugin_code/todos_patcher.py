...
class TodosPatcher:
    ...
    @staticmethod
    def __is_builtin_highlight_max(style_func_qname: str, style_func: Union[Callable, partial]) -> bool:
        if isinstance(style_func, partial):
            # pandas >= 1.3.2
    ...
    @staticmethod
    def __is_builtin_highlight_min(style_func_qname: str, style_func: Union[Callable, partial]) -> bool:
        if isinstance(style_func, partial):
            # pandas >= 1.3.2
