...
# highlight_between: https://github.com/pandas-dev/pandas/blob/v2.2.0/pandas/io/formats/style.py#L3345-L3446
class HighlightBetweenPatcher(TodoPatcher):
    ...
    def _styling_func(self,
        ...
        # https://github.com/pandas-dev/pandas/blob/v2.2.0/pandas/io/formats/style.py#L3873-L3877
