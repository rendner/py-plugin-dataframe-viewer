...
def test_detect_not_chunk_aware_styling_function(axis: Literal['index', 'columns']):
...
@pytest.mark.parametrize("axis", ['index', 'columns'])
def test_no_problem_for_chunk_aware_styling_function_1(axis: Literal['index', 'columns']):
...
@pytest.mark.parametrize("axis", ['index', 'columns'])
def test_no_problem_for_chunk_aware_styling_function_2(axis: Literal['index', 'columns']):
