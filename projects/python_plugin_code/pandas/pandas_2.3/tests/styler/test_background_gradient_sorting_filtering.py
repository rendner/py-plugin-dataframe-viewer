...
def test_cells__axis_columns(combine: bool):
    ...
    assert actual.cells == [
        [
            ...
            Cell(
                value='3',
                meta=CellMeta.min(background_color='#73a9cf', text_color='#f1f1f1').pack(),
            ),
            Cell(
                value='6',
        ...
        [
            ...
            Cell(
                value='5',
                meta=CellMeta.max(background_color='#73a9cf', text_color='#f1f1f1').pack(),
            ),
            Cell(
                value='8',
                meta=CellMeta.max(background_color='#023858', text_color='#f1f1f1').pack(),
...
def test_cells__axis_none(combine: bool):
    ...
    assert actual.cells == [
        ...
        [
            ...
            Cell(
                value='5',
                meta=CellMeta.max(background_color='#358fc0', text_color='#f1f1f1').pack(),
            ),
            Cell(
                value='8',
                meta=CellMeta.max(background_color='#023858', text_color='#f1f1f1').pack(),
