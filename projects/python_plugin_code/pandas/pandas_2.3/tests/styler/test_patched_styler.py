            ...
            structure=TableStructure(
                ...
                column_info=TableStructureColumnInfo(
                    ...
                    columns=[
                        ...
                        TableStructureColumn(dtype='str', labels=['d'], id=3),
    ...
    assert ps.get_info() == ps.serialize(TableInfo(
        ...
        structure=TableStructure(
            ...
            column_info=TableStructureColumnInfo(
                legend=None,
                columns=[
                    TableStructureColumn(dtype='int64', labels=['1'], id=0, text_align=TextAlign.RIGHT),
                    TableStructureColumn(dtype='int64', labels=['2'], id=1, text_align=TextAlign.RIGHT),
                    TableStructureColumn(dtype='int64', labels=['3'], id=2, text_align=TextAlign.RIGHT),
                    TableStructureColumn(dtype='int64', labels=['4'], id=3, text_align=TextAlign.RIGHT),
                    TableStructureColumn(dtype='int64', labels=['5'], id=4, text_align=TextAlign.RIGHT)
                ],
            )
        ),
    ))
