...
from cms_rendner_sdfv.base.types import ChunkDataResponse, Cell, TableStructureColumn, \
    TableStructureColumnInfo, TableInfo, TableStructure, TableSourceKind, Region, CellMeta, \
    TextAlign
...
def test_table_info_after_hiding_some_cols():
    styler = df.style \
...
def test_table_info_after_hiding_some_cols_and_filtering():
    styler = df.style \
        .hide_columns(subset=["col_1", "col_3"])
