...
from plugin_code.patched_styler_context import Region, PatchedStylerContext, IndexTranslator
            ...
            for element in last_row:
                ...
                if element.get("is_visible", True):
                    if "index_name" in element_classes:
                        display_value = DisplayValueTruncator(300, False).truncate(
                            element.get("display_value", element.get("value", "")),
                        )
