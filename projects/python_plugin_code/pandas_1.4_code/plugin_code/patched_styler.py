...
class PatchedStyler:
    ...
    def get_table_structure(self) -> TableStructure:
        ...
        return TableStructure(
            ...
            row_levels_count=visible_data.index.nlevels - styler.hide_index_.count(True),
            column_levels_count=visible_data.columns.nlevels - styler.hide_columns_.count(True),
